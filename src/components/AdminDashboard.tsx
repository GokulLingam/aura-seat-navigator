...
const AdminDashboard = () => {
  ...
  const adminFeatures = [
    {
      ...
      description: 'Create, edit, and manage office layouts',
      icon: MapPin,
      color: 'bg-blue-500',
      features: ['Add/Remove Seats', 'Create Desk Areas', 'Manage Symbols', 'Layout Configuration']
    },
    {
  ...
  const quickActions = [
    { label: 'Add New Seat', icon: Plus, path: '/floor-plan' },
